...
----
	...
	server.compression.mime-types=text/html,text/xml,text/plain,text/csstext/javascript,application/javascript # Comma-separated list of MIME types that should be compressed. For instance `text/html,text/css,application/json`
